...
Ordered by what you can start today, NOT by what matters most. That's the
opposite of GROWTH-TODO.md and it's deliberate — items 1 through 3 are small and
depend on nothing, so they're first. But item 4 is the actual point of this
round. The second floor is the thing that gives the game somewhere to go, and
items 5 and 6 are both waiting on it. If you only get one thing done, get that
one.
