...
SERVER_MODULES = ["DataService", "Analytics", "Economy", "SessionService", "SocialService", "MovementService",
                  "HelpService", "PartyService", "RaidService", "RecallService", "TowerService", "DisclosureService", "ShopService", "ObjectiveService", "LeaderboardService", "CombatService", "MapBuilder", "Tycoon"]
...
CLIENT_MODULES = ["UiKit", "HUD", "CombatClient", "MovementClient", "PartyUI", "ShopUI", "ObjectivesUI", "RebirthUI", "CompassUI", "TowerUI", "UpgradeUI", "SessionUI", "Main.client"]
